...
//Google Map One
	var latlng = new google.maps.LatLng(55.2841256,-114.760374);
	var settings = {
		zoom: 16,
		center: new google.maps.LatLng(55.2841256,-114.760374), mapTypeId: google.maps.MapTypeId.ROADMAP,
	...
	var companyPos = new google.maps.LatLng(55.2841256,-114.760374);
...
//
//
//var map = new google.maps.Map(document.getElementById("map_canvas_two"), settings);
//
//google.maps.event.addDomListener(window, "resize", function() {
//    var center = map.getCenter();
//    google.maps.event.trigger(map, "resize");
